...
print(species_type)
#answer = mammal, bird, reptile, amphibian, fish, vascular plant, nonvascular plant
...
#Endangered, In Recovery, Species of Concern, Threatened, null
...
#13.1 = create wide figure
plt.figure(figsize = (16,4))

#13.2 = create axes object
ax = plt.subplot()

#13.3 = create bar chart 
#heights = to observations column of obs_by_park
plt.bar(range(len(obs_by_park)), obs_by_park.observations)

#13.4 = create x-tick
ax.set_xticks(range(len(obs_by_park.observations)))

#13.5 = create x-tick labels
...
#14.2
# 100 * 5 / 15 = 33.3333333
minimum_detectable_effect = 33.3333333
...
#14.4
# Yellowstone National Park = 1.71597633136 weeks
